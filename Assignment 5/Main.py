...
"""
# --------------- Constants -----------------
ASTERISK = '*' # Askerisk symbol
CHAR_LENGTH = 1 # Length of a character
STRING_MIN_LENGTH = 6 # Minimum string length
STRING_MAX_LENGTH = 500 # Maximum string length
...
def get_key_character():
   ...
   """
   user_input = "" # Begin with empty string to hold users input
...
def mask_character(the_string, key_character):
   ...
   """
   temp_string = "" # Empty string to hold the updated string
   for c in the_string: # Loops through every character in the string
      if c == key_character: # Checks if character equals the key character
         temp_string += ASTERISK # Adds asterisk in place of character
      else: # If character does not equal key character
         temp_string += c # Adds character from the_string
...
def remove_character(the_string, key_character):
   ...
   for c in the_string: # Loops through every character in the string
      if c != key_character: # Checks if character does not equal key
         temp_string += c # Adds every character that does not equal key
...
def count_key(the_string, key_character):
   ...
   """
   char_count = 0 # Setting number of instances of key to zero
   for c in the_string: # Loops through every character in the string
      if c == key_character: # Checks if character equals the key character
         char_count += 1 # Adds one to count of key
